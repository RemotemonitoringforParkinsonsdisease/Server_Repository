...
public class DoctorJDBC implements DoctorManager {
    ...
    // Metodo para agregar un doctor (mejorado para manejar auto incremento de doctor_id)
    ...
    // Metodo para obtener un doctor aleatorio
    ...
    // Metodo para obtener la contraseña del doctor por su doctor_id
